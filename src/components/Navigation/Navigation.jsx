    ...
    <ul className={styles.navigation}>
      <li className={styles.navigation__item}>
        <a href="#" className={styles.navigation__link}>
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Dashboard</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
      ...
      <li className={styles.navigation__item}>
        <a href="#" className={styles.navigation__link}>
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className={styles.navigation__img + ' ' + styles.fill}
          >
            <path
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Product</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
      ...
      <li className={styles.navigation__item + ' ' + styles.active}>
        <a href="#" className={styles.navigation__link}>
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Customers</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
      ...
      <li className={styles.navigation__item}>
        <a href="#" className={styles.navigation__link}>
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Income</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
      ...
      <li className={styles.navigation__item}>
        <a href="#" className={styles.navigation__link}>
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Promote</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
      ...
      <li className={styles.navigation__item}>
        <a href="#" className={styles.navigation__link}>
          ...
          <div className={styles.navigation__wrapper}>
            <p className={styles.navigation__text}>Help</p>
            <svg
              width="6"
              height="10"
              viewBox="0 0 6 10"
